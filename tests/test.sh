...
actual="$(../extract-shell-variables.php --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php -e fixtures/test-data-excluded.txt --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php -e fixtures/test-data-excluded.txt --filter-prefix=VAR1 --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php -t --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php -t -s --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php -t -l fixtures/test-data-ticks-included.txt -s --filter-global fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php --filter-global fixtures/test-data.bash fixtures/test-data.sh)"
...
actual="$(../extract-shell-variables.php --filter-global --markdown=fixtures/test-template.md fixtures/test-data.sh)"
